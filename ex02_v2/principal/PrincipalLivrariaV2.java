...
import entidades.LivroV2;

import java.util.Scanner;
import entidades.LivrariaV2;

public class PrincipalLivrariaV2 {

	public static void main(String[] args) {
		Scanner lerDados = new Scanner(System.in);
		LivrariaV2 livraria = new LivrariaV2();
		...
		do {
			...
			case 1:
				...
				LivroV2 livro = new LivroV2(nome, codigo, autor, quantidade);
